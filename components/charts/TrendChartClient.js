...
/**
 * Composant client : affiche le graphique ou l'état d'erreur.
 * Reçoit les données déjà résolues côté serveur par TrendChart.
 */
function TrendChartClient({ indic, historicalData, trendData, error }) {
  if (error) {
    return (
...
export default TrendChartClient;
