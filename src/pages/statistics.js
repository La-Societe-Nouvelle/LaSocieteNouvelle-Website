		...
		datasets: [
			{
				...
				data: [8228,10401,14496,14130,223616,115899,11453,8928,43561,24165,43014,39175,35269,30483],
...
const ApiEndpointUsageChart = () => 
{
	...
	const chartData = {
		...
		datasets: [
			{
				label: 'Nombre de requêtes',
				data: [441879,82141,120250,10378],
...
const WebsiteNbVisitsChart = () => 
{
	...
	const chartData = {
		labels: ['2024-05','2024-06','2024-07','2024-08','2024-09','2024-10','2024-11','2024-12','2025-01','2025-02'],
		datasets: [
			{
				label: 'Nombre de visites',
				data: [255,249,359,236,374,466,427,330,342,382],
				backgroundColor: '#191558',
				borderColor: '#191558'
			}
		]
