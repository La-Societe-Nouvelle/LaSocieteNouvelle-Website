  ...
  return (
    ...
    <>
        ...
        <Container>
          <Row>
            <Col>
              ...
              <p>
                Mesurer les impacts de sa valeur ajoutée et de sa valeur produite permet d'évaluer sa capacité à produire de la valeur en limitant ses impacts négatifs, de se positionner vis-à-vis de sa branche d'activités et des objectifs de développement durable fixés.
              </p>
              <p>
                Les indicateurs permettent d'informer vos clients sur les impacts liés à leurs dépenses et apportent ainsi une véritable transparence.
              </p>
            </Col>
            <Col>
      ...
      <section id="cta-entreprise" className="text-center cta-metriz">
        <Container>
          <h3 className="h4">Mesurer vos indicateurs grâce à notre application web METRIZ</h3>
          <p>
          ...
          les données disponibles au sein de notre base de données ouverte et vos impacts directs pour produire automatiquement des 
